<?php
/**
 * Plugin Name:         SimpleCountdown
 * Plugin URI:          https://github.com/xwolfde/SimpleCountdown
 * GitHub Plugin URI:   https://github.com/xwolfde/SimpleCountdown
 * Description:         Displays a countdown to a given time with a shortcode.
 * Version:             1.0.0
 * Author:              xwolf
...
class SimpleCountdown {
    ...
    function register_scripts() {    
        ...
        wp_register_style( 'SimpleCountdown-CSS', plugins_url('assets/css/style.css', dirname(__FILE__) ) );
        wp_register_script( 'SimpleCountdown-JS', plugins_url('assets/js/scripts.min.js', dirname(__FILE__)), array('jquery'),'' , true);
    }
}